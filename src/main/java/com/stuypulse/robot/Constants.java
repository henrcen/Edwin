...
public interface Constants {
    ...
    double DISTANCE_FROM_START_TO_ENEMY_TRENCH = -1;
    double DISTANCE_FROM_ENEMY_TRENCH_TO_TRENCH = -1;
    double ANGLE_FROM_TRENCH_TO_TWO_BALL = -1;
    double DISTANCE_FROM_TRENCH_TO_TWO_BALL = -1;
